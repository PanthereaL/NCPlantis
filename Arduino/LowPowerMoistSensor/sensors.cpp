...
void initiate_sensors() {
  pinMode(MOIST_SENSOR_CONTROL_PIN[0], OUTPUT);
  ...
  digitalWrite(MOIST_SENSOR_CONTROL_PIN[0], HIGH);
  ...
  digitalWrite(MOIST_SENSOR_CONTROL_PIN[0], LOW);
...
void turn_on(size_t index) {
  digitalWrite(MOIST_SENSOR_CONTROL_PIN[index], HIGH);
}

void turn_off(size_t index) {
  digitalWrite(MOIST_SENSOR_CONTROL_PIN[index], LOW);
}
}
